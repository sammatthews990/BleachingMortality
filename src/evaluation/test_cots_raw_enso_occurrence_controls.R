...
save_figure_bundle(p_cots,'Fig-INLA-16_cots_raw_timing_screen',cots_plot_data,
  ...
  code_source='src/evaluation/test_cots_raw_enso_occurrence_controls.R',width=11,height=5.5)
save_figure_bundle(p_event,'Fig-INLA-17_lanina_occurrence_state',event_plot_data,
  ...
  code_source='src/evaluation/test_cots_raw_enso_occurrence_controls.R',width=10,height=6)
save_figure_bundle(p_audit,'Fig-INLA-18_lanina_named_reef_audit',named_audit,
  ...
  code_source='src/evaluation/test_cots_raw_enso_occurrence_controls.R',width=11,height=7)
