...
gb_inter$pred <- apply(pp_b, 2, median); gb_inter$pred_lo <- apply(pp_b, 2, quantile, 0.05); gb_inter$pred_hi <- apply(pp_b, 2, quantile, 0.95)
...
gf <- data.frame(MaxDHW_s = rep(seq(dhw_min_s, dhw_max_s, length.out = 200), 2),
